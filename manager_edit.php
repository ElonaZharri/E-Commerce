...
//alert(oid);
    ...
    <body>
        ...
        <h2 class="title text-center"><br>Manage Orders</h2>
...
?>
            ...
            <td><input type="text" name ="new_oid" id= "new_oid" value="<?php echo $Oid?>" readonly></input></td>
               ...
               <td><?php echo $state?></td>
                <td><?php echo $zip?></td>
                <td><input type="submit" name="update_quantity_abidha" formaction="/~kimd35/1st_look/manager_edit.php"  value="Update" id="update" onclick="UpdateTable();"/></td>
                <div id="msg"></div>
                <td><a class="cart_quantity_delete" href="manager_orders.php">Delete</a></td>
              </tr>
