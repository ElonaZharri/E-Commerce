					...
					<div class="col-sm-8">
						<div class="shop-menu pull-left">
							<ul class="nav navbar-nav">
                                ...
                                <li><a href="manager_products.php?admin_products" class="active">Manage Products</a></li>
								<li><a href="manager_orders.php?admin_orders">Manage Orders</a></li>
...
?>
              ...
              <tr>
                ...
                <td><input type="submit" name="update_quantity_abidha" formaction="/~kimd35/1st_look/manager_edit_products.php" value="Update" id="update" onclick="UpdateTable();"/></td>
                <div id="msg"></div>
