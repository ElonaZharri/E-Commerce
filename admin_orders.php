		...
		<div class="header-middle"><!--header-top-->
			<div class="container">
				<div class="row" >
				 ...
				 <div>
                     <form method="get" action="results_orders.php" enctype="multipart/form-data">
...
?>
              ...
              <tr>
                ...
                <td><?php echo $zip?></td>
                <td><a class="cart_quantity_edit" href="edit.php">Edit</a></td>
                <td><a class="cart_quantity_delete" href="admin_orders.php?delete= <?php echo $row['Oid']; ?>">Delete</a></td>
              </tr>
