...
<head>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-left">
							<ul class="nav navbar-nav">
                                ...
                                <li><a href="employee_products.php" class="active">View Products</a></li>
					 ...
					 <div>
                     <form method="get" action="employee_results_products.php" enctype="multipart/form-data">
	...
	<h2 class="title text-center"><br>[EMPLOYEE] View Products</h2>
