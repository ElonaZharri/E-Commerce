...
<head>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-left">
							<ul class="nav navbar-nav">
                                ...
                                <li><a href="manager_products.php" class="active">Manage Products</a></li>
					 ...
					 <div>
                     <form method="get" action="manager_results_products.php" enctype="multipart/form-data">
	...
	<h2 class="title text-center"><br>[Manager] Manage Products</h2>
...
?>
              ...
              <tr>
                ...
                <td><a class="cart_quantity_edit" href="manager_edit_products.php">Edit</a></td>
                <td><a class="cart_quantity_delete" href="manager_products.php?delete= <?php echo $row['Pid']; ?>">Delete</a></td>
              </tr>
