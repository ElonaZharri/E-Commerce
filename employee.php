					...
					<div class="col-sm-8">
						<div class="shop-menu pull-left">
							<ul class="nav navbar-nav">
								...
								<li><a href="employee.php" class="active">Home</a></li>
                                <li><a href="employee_products.php">View Products</a></li>
								<li><a href="employee_orders.php">View Orders</a></li>
		...
		<div class="container">
				<!--<div class="col-sm-9 padding-right">-->
					<div class="features_items"><!--dresses-->
						<h2 class="title text-center"><br>Welcome Staff Member</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="employee_products.php" class="btn btn-default add-to-cart">Dresses</a>
										</div>
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="employee_products.php" class="btn btn-default add-to-cart">Hair Pins</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="employee_products.php" class="btn btn-default add-to-cart">Foot Wear</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="employee_products.php" class="btn btn-default add-to-cart">Tiara</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<a href="employee_products.php" class="btn btn-default add-to-cart">Rings</a>
									</div>
								</div>
							</div>
						</div>
