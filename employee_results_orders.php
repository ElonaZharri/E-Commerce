...
<head>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-left">
							<ul class="nav navbar-nav">
								...
								<li><a href="employee_orders.php" class="active">View Orders</a></li>
					 ...
					 <div>
                     <form method="get" action="employee_results_orders.php" enctype="multipart/form-data">
	...
	<h2 class="title text-center"><br>[EMPLOYEE] VIEW ORDERS</h2>
<?php
